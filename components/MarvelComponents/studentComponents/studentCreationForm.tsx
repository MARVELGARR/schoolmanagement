...
export const formSchema = z.object({
    ...
    about: z.string().min(20,{
        message: 'write atleast 20 characters long'
    }).max(2000,{
        message:'must not be more that 2000 characters'
    })
...
const StudentForm = () => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        values.images = uploadedImageUrl || '';
        ...
        try{
            if(values.images !== null) {
                ...
                const NewStudent = await fetch('/api/createStudent', {
                    method: 'POST',
                    headers: {
